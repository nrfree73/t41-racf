...
#pragma compile(FileDescription, [T41 v3.3d])
#pragma compile(ProductName, [T41 v3.3d])
#pragma compile(LegalCopyright, (03/2023) - Nicolas RISTOVSKI)
...
EndIf ; $LancerRumba=1 ?
ToolTip("  t41.exe (v3.3d)  =>   DSEM/EAPI69/nicolas RISTOVSKI  (06/2023)",5,5,"")
if $LancerRumba=1 Then
sleep(7000)
Else
sleep(2000)
